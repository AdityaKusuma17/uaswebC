...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Hotel -->
            <li class="nav-item">
                <a class="nav-link" href="tabelhotel.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tablelvilla.php">
             ...
             <!-- Nav Item - Tables -->
             <li class="nav-item">
                <a class="nav-link" href="tabelapart.php">
                    <i class="fas fa-fw fa-table"></i>
             ...
             <!-- Nav Item - Tables -->
             <li class="nav-item">
                <a class="nav-link" href="tabeluser.php">
                    <i class="fas fa-fw fa-table"></i>
