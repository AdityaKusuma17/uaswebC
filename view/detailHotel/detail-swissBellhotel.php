            ...
            <div class="container">
                <div class="hotel-card row">
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <img src="../../img/imageForMenuTampilan/swiss bellhotel.webp" class="img-fluid"
                            alt="The Rooms Apartment Bali by ARM Hospitality">
                    </div>
                    <div class="col-md-6 hotel-content">
                        <div class="hotel-title text-primary fw-bold fs-2">Swiss Belhotel Rainforest</div>
                        <div class="card-body">
                        ...
                        <p>
                            For those seeking good quality service at affordable prices, Swiss Belhotel Rainforest is
                            the right choice. Despite its affordability, this accommodation offers adequate facilities
                            while maintaining service quality. If you have an agenda requiring a large room, Swiss
                            Belhotel Rainforest is ideal, boasting spacious meeting rooms and various supporting
                            facilities. Conveniently located near Ngurah Rai International Airport (DPS), it's perfect
                            for overnight stays between flights, offering comfortable rest during layovers.
                        </p>
